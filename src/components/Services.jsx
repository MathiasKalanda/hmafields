...
const services = [
  {
    ...
    description:
      "Expert construction services for residential, commercial, and infrastructure projects, delivering high-quality builds on time and within budget.",
  },
  {
    icon: <FiCalendar className="w-12 h-12 text-blue-600" />,
    title: "Events Management",
    description:
      "Full-service event planning and execution, from corporate functions and conferences to weddings and launches, ensuring memorable experiences.",
  },
  {
